chart = {
    ...
    initChartist: function (model) {
        var totalExpenses = model.ExpensesByMonth;
        var mandatoryExpenses = model.MandatoryExpensesByMonth;
        var discretionaryExpenses = model.DiscretionarySpendingByMonth;
    ...
    //    var dataSales = {
    //        labels: [, "12:00AM", "3:00PM", "6:00PM", "9:00PM", "12:00PM", "3:00AM", "6:00AM"],
    //        series: [
