...
declare module "ej/web.all" {
    export { EJ_GRID_COMPONENTS, GridComponent, ColumnsDirective, SummaryColumnsDirective, SummaryColumnDirective, SummaryRowsDirective, SummaryRowDirective, StackedHeaderColumnsDirective, StackedHeaderColumnDirective, StackedHeaderRowsDirective, StackedHeaderRowDirective } from "ej/grid.component";
    export { EJ_CHART_COMPONENTS, ChartComponent, StripLineCollectionDirective, stripLineDirective, AxesDirective, AxisDirective, TrendlinesDirective, TrendlineDirective, PointDirective, SeriesCollectionDirective, SeriesDirective, IndicatorsDirective, IndicatorDirective, AnnotationsDirective, AnnotationDirective, PrimaryXAxisStripLineCollectionDirective, PrimaryXAxisStripLineDirective, PrimaryYAxisStripLineCollectionDirective, PrimaryYAxisStripLineDirective, PaletteCollectionDirective, PaletteDirective, ToolbarItemsDirective, ToolbarItemDirective, RowDefinitionsDirective, RowDefinitionDirective, ColumnDefinitionsDirective, ColumnDefinitionDirective } from "ej/chart.component";
    export { EJ_RANGENAVIGATOR_COMPONENTS, RangeNavigatorComponent, PointsDirective } from "ej/rangenavigator.component";
    ...
    export { EJ_CIRCULARGAUGE_COMPONENTS, CircularGaugeComponent, PointersDirective, PointerDirective, LabelsDirective, TicksDirective, RangesDirective, StateRangesDirective, SubGaugesDirective, SubGaugeDirective, CustomLabelsDirective, CustomLabelDirective, ScalesDirective } from "ej/circulargauge.component";
    export { EJ_LINEARGAUGE_COMPONENTS, LinearGaugeComponent, MarkerPointersDirective, MarkerPointerDirective, BarPointersDirective, BarPointerDirective, RangeDirective, TickDirective, StateRangeDirective, LabelDirective, ScaleDirective } from "ej/lineargauge.component";
    export { EJ_DIGITALGAUGE_COMPONENTS, DigitalGaugeComponent, ItemDirective } from "ej/digitalgauge.component";
    ...
    export { EJ_GANTT_COMPONENTS, GanttComponent, StriplinesDirective, StriplineDirective, HolidaysDirective, HolidayDirective, SelectedCellIndexesDirective, EditDialogFieldsDirective, EditDialogFieldDirective, AddDialogFieldsDirective, AddDialogFieldDirective, ColumnDialogFieldsDirective, ColumnDialogFieldDirective } from "ej/gantt.component";
    export { EJ_TREEGRID_COMPONENTS, TreeGridComponent, SelectedCellIndexDirective } from "ej/treegrid.component";
    ...
    export { EJ_KANBAN_COMPONENTS, KanbanComponent, ColumnDirective } from "ej/kanban.component";
    ...
    export { EJ_LISTVIEW_COMPONENTS, ListViewComponent, ItemsDirective } from "ej/listview.component";
